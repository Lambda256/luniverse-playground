...
export const getMetadata = (metatdataId: string) => axios.request({
	baseURL: Config.BASE_URL,
	url: Config.NFT_METADATA_URL + `/${metatdataId}`,
	method: "get",
	headers: {
		Authorization: `Bearer ${Config.AUTH_TOKEN}`,
	},
...
export const mintERC721 = (metadataId: string, editionNo: number, account: string) => axios.request({
	baseURL: Config.BASE_URL,
...
export const getNFTInfo = (itemId: string) => axios.request({
	baseURL: Config.BASE_URL,
